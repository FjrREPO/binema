...
import useMobileMode from '@/utils/hooks/useMobileMode';
import dynamic from 'next/dynamic';

const CarouselItem = dynamic(() => import('@/components/client/element/Carousel'), { ssr: false });
const SliderCard = dynamic(() => import('../../element/SliderCard'), { ssr: false });
